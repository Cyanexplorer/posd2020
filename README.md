...
6. Modify makfile to generate binary file `geo` under "bin" folder.  
   ...
   [input.txt](https://ssl-gitlab.csie.ntut.edu.tw/108598011/posd2020f_assignment/tree/HW3/input.txt)  
   [output.txt](https://ssl-gitlab.csie.ntut.edu.tw/108598011/posd2020f_assignment/tree/HW3/output.txt)  
   ```
   bin/geo input.txt output.txt area inc
   ```
